...
The results for the brute force Monte Carlo integration are showed in Table \ref{Tab: MC}, and the integration values for the improved Monte Carlo method are showed inn Table \ref{Tab: improvedMC}. In Table \ref{Tab: MC} and \ref{Tab: improvedMC} also lists the time used for calculating the integral. When we parallelised our code we experienced a quicker calculation of the integral. \\
...
\begin{table}[h!]
  \caption{: Integration using improved Monte Carle integration, variying N}
