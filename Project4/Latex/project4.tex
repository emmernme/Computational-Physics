...
\begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[width=280px]{./plot/Mean_energy.png}
        \caption{Mean Energy }
\end{subfigure} \hfill %
\begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[width=280px]{./plot/Mean_magnetization.png}
...
\begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[width=280px]{./plot/specific_heat.png}
        \caption{Specific Heat}
\end{subfigure} \hfill %
\begin{subfigure}{.5\textwidth}
        \centering
        \includegraphics[width=280px]{./plot/susceptibility.png}
...
\section{Appendix}
	...
	\subsection{Expectation Values for the Energy}
		...
		\begin{flalign*}
			...
			&= 64J^2 \frac{\left(e^{-8\beta J} - e^{8\beta J} \right)^2 }{\left(e^{8\beta J} + e^{-8 \beta J} + 6 \right)^2 }\\
			&= 64 J^2 \frac{e^{-16\beta J} + e^{16 \beta J} + 2}{e^{16\beta J} + e^{-12\beta J} + 12e^{-8\beta J} + 16e^{8 \beta J} +  38}
		\end{flalign*}
	...
	\subsection{Expectation Values for the Magnetization}
		...
		\begin{flalign*}
			...
			\left<|M(T)|\right> &= \frac{8e^{8\beta J} + 12}{2e^{8 \beta J} + 2e^{-8 \beta J} + 16} = \frac{4e^{8\beta J} + 8}{e^{8 \beta J} + e^{-8 \beta J} + 6}
		\end{flalign*}
	...
	\subsection{Susceptibility}
		...
		\begin{flalign*}
			\chi = \frac{16}{k_BT} \left[{\frac{e^{8\beta J} + 1}{e^{8 \beta J} + e^{-8 \beta J} + 6} -\frac{e^{16\beta J} + 4e^{8\beta J} + 4}{e^{-16\beta J} + e^{-16\beta J} + 12e^{-8\beta J} + 12e^{8 \beta J} + 38}}\right]
		\end{flalign*}
