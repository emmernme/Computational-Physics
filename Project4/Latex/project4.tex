...
We have used the values in Table \ref{Tab: EogM} to calculate, the expectationvalues for the energy and the mean magnetization as well. These values have then been used to calculate the variance for the two physical quantities. The variance for the energi and the mean mean magnetization have respectively been used to calculate the heat capacity $C_v &= \sigma^2_E/k_BT$ and the susceptibility $ \chi = \sigma_M^2/k_BT$

In Table \ref{Tab: values} the values for the properties above are shown if we set $J/k_BT = 1$.
...
\begin{flalign*}
  ...
  &= \frac{64Je^{8\beta J} + 2\left(64Je^{-8\beta J}\right) + 64Je^{8\beta J}}{2e^{8 \beta J} + 2e^{-8 \beta J} + 16}\\
  &= \frac{128Je^{8\beta J} + 128Je^{-8\beta J}}{2e^{8 \beta J} + 2e^{-8 \beta J} + 16}\\
  &= \frac{64Je^{8\beta J} + 64Je^{-8\beta J}}{e^{8 \beta J} + e^{-8 \beta J} + 8}
\end{flalign*}
...
\begin{flalign*}
  ...
  &= \frac{64Je^{8\beta J} + 64Je^{-8\beta J}}{e^{8 \beta J} + e^{-8 \beta J} + 8} - 64 J^2 \frac{e^{-16\beta J} + e^{16 \beta J} + 2}{e^{-16\beta J} + e^{-16\beta J} + 16e^{-8\beta J} + 16e^{8 \beta J} + 66 }
\end{flalign*}

When this is known we can also calculate the heat capasitace.
\begin{flalign*}
  C_v &= \frac{\sigma^2_E}{k_bT}\\
  &= \frac{64J}{k_BT}\left[\frac{e^{8\beta J} + e^{-8\beta J}}{e^{8 \beta J} + e^{-8 \beta J} + 8} -  J \frac{e^{-16\beta J} + e^{16 \beta J} + 2}{e^{-16\beta J} + e^{-16\beta J} + 16e^{-8\beta J} + 16e^{8 \beta J} + 66 }\right]
\end{flalign*}
