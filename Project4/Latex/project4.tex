...
We use this to calculate the standard deviation
\begin{flalign*}
...
\begin{flalign*}
  ...
  &= \frac{\frac{64Je^{8\beta J} + 64Je^{-8\beta J}}{e^{8 \beta J} + e^{-8 \beta J} + 8} - 64 J^2 \frac{e^{-16\beta J} + e^{16 \beta J} + 2}{e^{-16\beta J} + e^{-16\beta J} + 16e^{-8\beta J} + 16e^{8 \beta J} + 66 }}{k_bT}
\end{flalign*}
