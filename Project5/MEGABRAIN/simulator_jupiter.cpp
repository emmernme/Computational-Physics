...
int main (int argv, char **argc){
	...
	Solar_system.VelocityVerlet(dim, N, years, "Earth+Jupiter.data");

	Solar_system.planets[2].mass *= 10;
	Solar_system.VelocityVerlet(dim, N, years, "Earth+Jupiter_mass_10.data");

	Solar_system.planets[2].mass *= 10;
	Solar_system.VelocityVerlet(dim, N, years, "Earth+Jupiter_mass_100.data");
