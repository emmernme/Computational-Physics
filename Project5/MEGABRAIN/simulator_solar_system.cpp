...
int main (int argv, char **argc){
	...
	for (double m : mass){
		...
		Planet Jupiter("Jupiter", dim, 0.00095 * m, 3.738323307080642E-01, -5.213724294602538E+00, 1.325968591237123E-02, 7.433486238916692E-03, 8.996700648060389E-04, -1.700539642140566E-04);
		...
		Solar_system.VelocityVerlet(dim, N, years, "Earth+Jupiter " + to_string(m) + ".data");
	}
